...
export default function TaskListCard({ item, teamId }: TaskListCardProps) {
  ...
  return (
    <article className="border-border-primary bg-background-primary hover:border-brand-primary/40 focus-within:ring-brand-primary/30 relative h-[151px] overflow-hidden rounded-xl border px-5 pt-5 pb-4 shadow-sm transition-all duration-200 focus-within:ring-2 hover:-translate-y-0.5 hover:shadow-md">
      <Link
